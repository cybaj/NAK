...
Sidebar.Scene = function ( editor ) {
	...
	container.addStatic( new UI.Text( '장면' ) );
	...
	fogTypeRow.add( new UI.Text( '안개' ).setWidth( '90px' ) );
	...
	fogColorRow.add( new UI.Text( '안개 색상' ).setWidth( '90px' ) );
	...
	fogNearRow.add( new UI.Text( 'FOG 근거리' ).setWidth( '90px' ) );
	...
	fogFarRow.add( new UI.Text( 'Fog 원거리' ).setWidth( '90px' ) );
	...
	fogDensityRow.add( new UI.Text( 'Fog 밀도' ).setWidth( '90px' ) );
