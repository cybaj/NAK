...
Sidebar.Project = function ( editor ) {
	...
	container.addStatic( new UI.Text( '프로젝트' ) );
	...
	rendererTypeRow.add( new UI.Text( '렌더러' ).setWidth( '90px' ) );
	...
	rendererAntialiasSpan.add( new UI.Text( '안티얼리어싱' ).setMarginLeft( '3px' ) );
	...
	rendererShadowsSpan.add( new UI.Text( '그림자' ).setMarginLeft( '3px' ) );
