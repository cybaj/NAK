...
Sidebar.Object3D = function ( editor ) {
	...
	objectNameRow.add( new UI.Text( '이름' ).setWidth( '90px' ) );
	...
	*/
	...
	objectPositionRow.add( new UI.Text( '위치' ).setWidth( '90px' ) );
	...
	objectRotationRow.add( new UI.Text( '회전' ).setWidth( '90px' ) );
	...
	objectScaleRow.add( new UI.Text( '축척' ).setWidth( '90px' ) );
	...
	objectColorRow.add( new UI.Text( '색상' ).setWidth( '90px' ) );
	...
	objectGroundColorRow.add( new UI.Text( 'Ground 색상' ).setWidth( '90px' ) );
	...
	objectDistanceRow.add( new UI.Text( '거리' ).setWidth( '90px' ) );
	...
	objectAngleRow.add( new UI.Text( '각도' ).setWidth( '90px' ) );
	...
	objectExponentRow.add( new UI.Text( '멱지수' ).setWidth( '90px' ) );
	...
	objectDecayRow.add( new UI.Text( '부식' ).setWidth( '90px' ) );
	...
	objectShadowRow.add( new UI.Text( '그림자' ).setWidth( '90px' ) );
	...
	objectVisibleRow.add( new UI.Text( '시각화' ).setWidth( '90px' ) );
	...
	objectUserDataRow.add( new UI.Text( '사용자 data' ).setWidth( '90px' ) );
