...
NaDbMaterial::NaDbMaterial()
{
    Init(ALUMINIUM);
}

NaDbMaterial::NaDbMaterial(const GsMaterialName& mat)
{
    Init(mat);
}

void NaDbMaterial::SetName(const GsMaterialName& mat)
{
    Init(mat);
}

void NaDbMaterial::SetAmbient(const NaDbColor& aCol)
{
    myAmbient = aCol;
}

void NaDbMaterial::SetDiffuse(const NaDbColor& aCol)
{
    myDiffuse = aCol;
}

void NaDbMaterial::SetSpecular(const NaDbColor& aCol)
{
    mySpecular = aCol;
}

void NaDbMaterial::SetAmbientCoeff(const float& aVal)
{
    myAmbientCoeff = aVal;
}

void NaDbMaterial::SetDiffuseCoeff(const float& aVal)
{
    myDiffuseCoeff = aVal;
}

void NaDbMaterial::SetSpecularCoeff(const float& aVal)
{
    mySpecularCoeff = aVal;
}

void NaDbMaterial::SetShininessCoeff(const float& aVal)
{
    myShininessCoeff = aVal;
}


NaDbColor NaDbMaterial::GetAmbient()	    const
{
    return myAmbient;
}

NaDbColor NaDbMaterial::GetDiffuse()	    const
{
    return myDiffuse;
}

NaDbColor NaDbMaterial::GetSpecular()	    const
{
    return mySpecular;
}

float	 NaDbMaterial::GetAmbientCoeff()	    const
{
    return myAmbientCoeff;
}

float	 NaDbMaterial::GetDiffuseCoeff()	    const
{
    return myDiffuseCoeff;
}

float	 NaDbMaterial::GetSpecularCoeff()    const
{
    return mySpecularCoeff;
}

float	 NaDbMaterial::GetShininessCoeff()   const
{
    return myShininessCoeff;
}

void NaDbMaterial::Init(const GsMaterialName& mat)
{
    switch(mat)
    {
	//Non Metals
