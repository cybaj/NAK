// GLSurface.cpp: implementation of the NaDbSurface class.
//
//////////////////////////////////////////////////////////////////////
...
void NaDbSurface::Display(const GsDisplayMode& dMode)
{
    displayMode = dMode;
    DefineDisplay();
}

void NaDbSurface::Hilight(const GsDisplayMode&)
{
    glPushAttrib(GL_LIGHTING_BIT);
    glDisable(GL_LIGHTING);
    glDisable(GL_COLOR_MATERIAL);
...
void NaDbSurface::SetColor(const GLubyte& red, const GLubyte& green, const GLubyte& blue)
{
...
void NaDbSurface::GetColor(GLubyte* colVect) const
{
...
NaGeGeometry* NaDbSurface::Geometry() const
{
    NaGeSurface* surf = pSurf->Copy();
    return surf;
}

void NaDbSurface::ComputeBoundLimits()
{
    /*
...
void NaDbSurface::ComputePoints()
{
    SMOOTH *= 6;
    ...
    NaGePoint3D curP; NaGeVector3D N;
...
void NaDbSurface::ComputeWFPoints()
{
...
void NaDbSurface::ComputeUIso(const double vPar)
{
...
void NaDbSurface::ComputeVIso(const double uPar)
{
