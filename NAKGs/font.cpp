...
/*
 * 'FontCreate()' - Load Windows font bitmaps into OpenGL m_display lists.
 */
...
FontCreate(HDC        hdc,       /* I - Device Context */
    ...
    if (_stricmp(typeface, (const char*)"symbol") == 0)
...
void
FontDestroy(_GLFONT *font) /* I - Font to delete */
    {
    if (font == (_GLFONT *)0)
        return;
...
FontPuts(_GLFONT     *font, /* I - Font to use */
         const char *s)    /* I - String to m_display */
    {
